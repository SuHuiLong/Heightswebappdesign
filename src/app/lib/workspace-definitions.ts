...
export const WORKSPACES: Record<WorkspaceId, WorkspaceDefinition> = {
  operations: {
    ...
    tagline: 'Detect, diagnose, and resolve fleet-wide problems',
    icon: 'activity',
  ...
  support: {
    ...
    tagline: 'Resolve tickets and support individual subscribers',
    icon: 'users',
    primaryObjects: ['ticket', 'subscriber', 'home', 'gateway'],
    exampleScenarios: [
  ...
  growth: {
    ...
    tagline: 'Identify and capture growth opportunities',
    icon: 'trending-up',
    primaryObjects: ['opportunity', 'segment', 'campaign'],
    exampleScenarios: [
    ...
    isImplemented: false, // Reserved for future
  },
};
  ...
  growth: [
    {
      ...
      prompt: 'Find users saturating WAN bandwidth who need plan upgrades.',
    },
    {
      id: 'grw-2',
      title: 'Churn Risk Analysis',
      description: 'Find silent sufferers at risk of cancelling service',
      prompt: 'Identify households with high quality degradation but no support tickets.',
    },
    {
      id: 'grw-3',
      title: 'VAS Campaign Targeting',
      description: 'Find households eligible for value-added services',
      prompt: 'Find households with gaming consoles but no parental control subscription.',
    },
  ],
};
